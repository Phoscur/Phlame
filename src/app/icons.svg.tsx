...
export const MineIcon = ({ className }: PropsWithChildren<Icon> = { className: '' }) => (
  <>
    ...
    >
      ...
      <rect x="47.5" y="20" width="5" height="30" fill="#7f1d1d" />
      <rect x="40" y="50" width="20" height="10" fill="#7f1d1d" />
    </svg>
  </>
);
...
export const PowerPlantSolarIcon = ({ className }: PropsWithChildren<Icon> = { className: '' }) => (
  <>
    <svg // generated by ChatGPT "Solar Power Plant"
      ...
      class={className}
    >
      <rect x="20" y="20" width="60" height="60" fill="#FFD600" />
      <rect x="30" y="20" width="40" height="10" fill="#212121" />
      <rect x="25" y="30" width="10" height="40" fill="#212121" />
      <rect x="65" y="30" width="10" height="40" fill="#212121" />
      <rect x="30" y="70" width="40" height="10" fill="#212121" />
    </svg>
  </>
);
...
export const PowerPlantFusionIcon = (
  ...
  <>
    ...
    >
      ...
      <circle cx="50" cy="50" r="10" fill="#FFD600" />
      <line x1="20" y1="50" x2="80" y2="50" stroke="#FFD600" stroke-width="2" />
      <line x1="50" y1="20" x2="50" y2="80" stroke="#FFD600" stroke-width="2" />
      <circle cx="50" cy="50" r="5" fill="#FFD600" />
      <line x1="50" y1="50" x2="70" y2="70" stroke="#FFD600" stroke-width="2" />
      <line x1="50" y1="50" x2="30" y2="30" stroke="#FFD600" stroke-width="2" />
      <line x1="50" y1="50" x2="70" y2="30" stroke="#FFD600" stroke-width="2" />
      <line x1="50" y1="50" x2="30" y2="70" stroke="#FFD600" stroke-width="2" />

      <defs>
        <radialGradient id="plasma-gradient" cx="50%" cy="50%" r="50%" fx="50%" fy="50%">
          <stop offset="0%" style="stop-color:#FFD600;stop-opacity:1" />
          <stop offset="100%" style="stop-color:#FFA000;stop-opacity:0" />
        </radialGradient>
      </defs>
    </svg>
  </>
