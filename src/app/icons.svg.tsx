...
export const SiloIcon = ({ className }: PropsWithChildren<Icon> = { className: '' }) => (
  <>
    <svg
      ...
      viewBox="0 0 100 100"
    >
      <rect x="30" y="20" width="40" height="60" fill="#9E9E9E" />
      <polygon points="20,20 50,10 80,20" fill="#616161" />
      <rect x="45" y="10" width="10" height="10" fill="#757575" />
      <rect x="45" y="70" width="10" height="10" fill="#757575" />
    </svg>
  </>
);
